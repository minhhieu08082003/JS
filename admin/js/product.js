...
function doCreate() {
    ...
    create_products(name,description,price,img,cat_id)
}

function create_products(name, description, description, price, img, cat_id) {
    let params = { 'name': name,'description' : description, 'price':price,'img':img,'category_id':cat_id }
...
function doUpdate(){
    ...
    let price = document.getElementById("price").value
    let img = document.getElementById("img").value
    update_products(id, description, name,img,price)
}

function update_products(id, description, name,img,price){
    let params = {'id': id,
    'name': name,
